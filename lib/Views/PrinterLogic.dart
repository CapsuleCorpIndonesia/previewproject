...
class PrinterLogic extends StatefulWidget {
  PrinterLogic({Key key}) : super(key: key);

  @override
  _PrinterLogicState createState() => _PrinterLogicState();
}

class _PrinterLogicState extends State<PrinterLogic> {
  @override
  Widget build(BuildContext context) {
    return Container();
  }
}
// https://pub.dev/packages/bluetooth_print - doesnt work
// https://pub.dev/packages/flutter_blue/
// https://pub.dev/packages/esc_pos_printer - wifi
// https://pub.dev/packages/esc_pos_bluetooth - bluetooth
/*
class PrinterLogic extends StatefulWidget {
  PrinterLogic({Key key, this.title = "hehe"}) : super(key: key);
  final String title;
